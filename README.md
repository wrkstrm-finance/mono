...
Wrkstrm Finance is a small, composable set of finance primitives
(brokers, market data, execution) designed to be:
...
- `public/readmes/public-readme` -> shared org-level README / issue templates
